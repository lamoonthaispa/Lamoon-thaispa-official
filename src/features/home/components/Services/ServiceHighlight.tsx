...
export default function ServiceHighlight({
  ...
  return (
    ...
    `}>
      ...
      <div className="w-[235px] h-[234px] md:w-[30%] md:h-[340px] lg:h-[340px] relative rounded-xl">
        <Image 
          src={image}
          alt={title}
          fill
      ...
      <div className="flex flex-col gap-[15px] md:gap-[20px] lg:gap-[30px] md:w-[70%]">
        <h1 className="text-landing-services-text-title text-2xl md:text-5xl lg:text-6xl">
          { title }
        </h1>

        <h3 className="text-landing-services-text-description text-xs md:text-sm lg:text-xl">
