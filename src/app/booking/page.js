...
const DEFAULT_MASSAGE_TYPES = [
  ...
  // Épilation Femme
  { value: "Epilation - Jambes entière (Femme)", label: "Epilation - Jambes entière (Femme)", description: "Epilation cire orientale - Jambes entière", category: "epilation", lockedDuration:30, prices: { 30: 35 }, image: "/cire-orientale.png" },
  ...
  { value: "Epilation - Bras entier (Femme)", label: "Epilation - Bras entier (Femme)", description: "Epilation cire orientale - Bras entier", category: "epilation", lockedDuration: 30, prices: { 30:32 }, image: "/cire-orientale.png" },
  ...
  { value: "Epilation - Sourcils (Femme)", label: "Epilation - Sourcils (Femme)", description: "Epilation cire orientale - Sourcils", category: "epilation", lockedDuration: 30, prices: { 30: 15 }, image: "/cire-orientale.png" },
  ...
  { value: "Epilation - Maillot intégral (Femme)", label: "Epilation - Maillot intégral (Femme)", description: "Epilation cire orientale - Maillot intégral", category: "epilation", lockedDuration: 30, prices: { 30: 40 }, image: "/cire-orientale.png" },
  { value: "Epilation - Maillot semi-intégral (Femme)", label: "Epilation - Maillot semi-intégral (Femme)", description: "Epilation cire orientale - Maillot semi-intégral", category: "epilation", lockedDuration: 30, prices: { 30: 29 }, image: "/cire-orientale.png" },
  { value: "Epilation - Maillot simple (Femme)", label: "Epilation - Maillot simple (Femme)", description: "Epilation cire orientale - Maillot simple", category: "epilation", lockedDuration: 30, prices: { 30: 17 }, image: "/cire-orientale.png" },
  { value: "Epilation - Fessier (Femme)", label: "Epilation - Fessier (Femme)", description: "Epilation cire orientale - Fessier", category: "epilation", lockedDuration: 30, prices: { 30: 29 }, image: "/cire-orientale.png" },
  ...
  { value: "Epilation - Jambes-entières (Homme)", label: "Epilation - Jambes-entières (Homme)", description: "Epilation cire orientale - Jambes-entières", category: "epilation", lockedDuration: 30, prices: { 30: 45 }, image: "/cire-orientale.png" },
  ...
  { value: "Epilation - Fessier (Homme)", label: "Epilation - Fessier (Homme)", description: "Epilation cire orientale - Fessier", category: "epilation", lockedDuration: 30, prices: { 30: 25 }, image: "/cire-orientale.png" },
  { value: "Epilation - Silicon interfessier (Homme)", label: "Epilation - Silicon interfessier (Homme)", description: "Epilation cire orientale - Silicon interfessier", category: "epilation", lockedDuration: 30, prices: { 30: 20 }, image: "/cire-orientale.png" },
